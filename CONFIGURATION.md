...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| `entry_pads` | string | `"16,2"` | Comma-separated pad numbers to press while holding KeySelect to toggle the mode. Pad 16 acts as the bank separator; pads 1–10 contribute digits. Example: `"16,3"` requires Pad 16 then Pad 3. |
